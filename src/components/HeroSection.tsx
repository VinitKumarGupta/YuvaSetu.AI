...
import { ArrowRight, BookOpen, Users, Award, TrendingUp, Globe } from 'lucide-react';
          ...
          <div className="relative">
            ...
            <div className="relative bg-gradient-to-br from-blue-100 to-orange-100 rounded-2xl p-8 shadow-xl">
              <div className="text-center">
                ...
                <h3 className="text-xl font-bold text-gray-900 mb-2">PM Narendra Modi</h3>
                <p className="text-gray-600 mb-4">Empowering Youth Through Digital India</p>
                <div className="bg-white rounded-lg p-4 shadow-sm">
                  <p className="text-sm text-gray-700 italic">
                    "Digital India is not just a vision, it's a mission to empower every citizen with technology."
                  </p>
                </div>
              </div>
